...
<div class="card-body p-2 row">
    ...
    <div class="d-flex justify-content-between align-items-start mb-2 col-sm-2">
        <div class="flex-grow-1">
            <div class="d-flex align-items-center flex-wrap gap-2">
                ...
                {{-- Mobile Hover Popover (FIXED: Added d-inline-block d-md-none) --}}
    ...
    <div class="col-sm-2 d-flex align-items-center" style="margin-top: -29px;">
        ...
        {{-- Desktop Hover Popover (FIXED: Added d-none d-md-inline-block) --}}
        @if(!empty($php_errormsg))
